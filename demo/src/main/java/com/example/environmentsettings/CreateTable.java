	...
	public void CreateTableAll() {
        ...
        sql = sb.append("create table if not exists customer_info(")
            ...
            try {
				...
				// TODO Auto-generated catch block
				e.printStackTrace();
				System.out.println("customer_info table generation failed.");
			}
        ...
        sql = sb.append("create table if not exists customer_address(")
            ...
            try {
				...
				// TODO Auto-generated catch block
				e.printStackTrace();
				System.out.println("customer_address table generation failed.");
			}
        sb.delete(0,sb.length());
        ...
        sql = sb.append("create table if not exists customer_organization(")
            ...
            try {
				...
				// TODO Auto-generated catch block
				e.printStackTrace();
				System.out.println("customer_organization table generation failed.");
			}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("payment table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("area table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("worker table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e1.printStackTrace();
			System.out.println("salary_log table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("nation table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("driver_license table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("unit_measure_size table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //vehicle table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("vehicle table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("driver_info table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("warehouse table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("warehouse_worker_info table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //unit_measure_weight table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("unit_measure_weight table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //parcel table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("parcel table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("whole_request table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //warehouse_connection table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("warehouse_connection table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e1.printStackTrace();
			System.out.println("a2a_request table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //d2a_request table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("d2a_request table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //cs_department table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("cs_department table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //cs_worker_info table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("cs_worker_info table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //board table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e1.printStackTrace();
			System.out.println("board table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //board_answer table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("board_answer table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //fedex_market table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("fedex_market table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //fedex_inventory table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("fedex_inventory table generation failed.");
      ...
      //pickup table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("pickup table generation failed.");
		}
        sb.delete(0,sb.length());
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("delegate_info table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //worker_base_pay table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("worker_base_pay table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //regulated_base_pay table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("regulated_base_pay table generation failed.");
		}
        sb.delete(0,sb.length());
      ...
      //request_minimum_charge table generation
        ...
        try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("request_minimum_charge table generation failed.");
		}
        sb.delete(0,sb.length());
